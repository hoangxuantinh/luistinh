    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <form action="{{ route('roles.update',['id' => $roleEdit->id]) }}" method="post" style="width:100%;">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Vai trò</label>
                                    <input type="text" class="form-control" value="{{ $roleEdit->name }}" name="name" placeholder="Nhập tên">

                                </div>
                                <div class="form-group">
                                    <label>Mô tả vai trò</label>
                                    <textarea type="text" class="form-control"  name="display_name" 
                                        placeholder="Nhập vai trò">{{ $roleEdit->display_name }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label >
                                                ...
                                                <div class="card-body col-md-3">
                                                    <h5 class="card-title">
                                                        <label>
                                                            ...
                                                            {{  $permissionCheck->contains('id',$permissionChildrent->id) ? 'checked' : ''  }}
                                                                name="permission_id[]" 
